...
You can then execute your native executable with: `./target/quark-iam-1.0.0-SNAPSHOT-runner`
...
- Redoc ([guide](https://docs.quarkiverse.io/quarkus-redoc/dev/)): OpenAPI/Swagger-generated API Reference Documentation using Redoc CE
